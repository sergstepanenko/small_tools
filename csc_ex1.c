...
int main (int argc, char *argv[])
{
	...
	imagefile[0].filename = "/freescale_1024x768_rgb565.raw";
	imagefile[0].fpixformat = v4l2_fourcc('R', 'G', 'B', 'P');

	imagefile[1].filename = "/freescale_1024x768_rgba32.raw";
	imagefile[1].fpixformat = v4l2_fourcc('R', 'G', 'B', 'A');

	imagefile[2].filename = "/freescale_1024x768_nv12.raw";
	imagefile[2].fpixformat = v4l2_fourcc('N', 'V', '1', '2');

	imagefile[3].filename = "/freescale_1024x768_yuyv422.raw";
